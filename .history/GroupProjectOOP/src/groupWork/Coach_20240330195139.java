...
public class Coach {
    ...
    public void edit_coach(String trnInput) throws IOException {
         ...
         * 
         * if (attribute_to_replace.getValue().getClass() !=
         * replacement_value.getValue().getClass()) {
        ...
        try {
            ...
            while ((line = coachScanner.readLine()) != null) {
                ...
                if (parts[0].equals(trnInput)) {
                    System.out.println(line);
                    continue;
                }

                System.out.println(parts[0] + " != " + trnInput);
